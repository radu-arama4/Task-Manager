...
/**
 * Proxy for implementing transactions for the methods of a given service annotated with @{@link
 * Transactional}. It includes start, commit and rollback operations.
 */
